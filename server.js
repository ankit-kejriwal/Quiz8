...
app.get('/company',(req,res)=>{
    pool.getConnection()
        .then(con => {
            con.query("Select * from company LIMIT 10")
                .then((rows) => {
 ...
 *      responses:
 *          200:
 *              description: Object containing arrays of customer
 */

app.get('/customer',(req,res)=>{
    pool.getConnection()
        .then(con => {
            con.query("Select * from customer LIMIT 10")
                .then((rows) => {
                    res.header('Content-Type','application/json');
                    res.status(200).send(rows);
                })
 ...
 *      responses:
 *          200:
 *              description: Object containing arrays of foods
 */

app.get('/foods',(req,res)=>{
    pool.getConnection()
        .then(con => {
            con.query("Select * from foods LIMIT 10")
                .then((rows) => {
                    res.header('Content-Type','application/json');
                    res.status(200).send(rows);
                })
 ...
 *      responses:
 *          200:
 *              description: Object containing arrays of agents
 */
...
app.get('/agents',(req,res)=>{
    pool.getConnection()
        .then(con => {
            con.query("Select * from agents LIMIT 10")
                .then((rows) => {
                    res.header('Content-Type','application/json');
                    res.status(200).send(rows);
                })
  ...
  app.delete('/foods/delete/:item_id',[
    ...
    .then(con =>{
        ...
        con.query("SELECT * FROM foods where ITEM_ID=?",[req.params.item_id]).then((row)=>{
            if(row.length==0){
              res.header("Content-Type", "application/json");
              res.status(500).send({error:"Data dose not exists"});
              con.close();
              return;
            }
